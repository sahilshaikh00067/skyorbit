...
function TrustedTicker() {
  ...
  return (
    <div className="ticker-strip">
      <span className="ticker-label">Trusted by teams at <br/> SR BUSINESS SOLUTIONS PRIVATE LIMITED </span>
    ...
    <section id="services" className="section">
      <div className="container">
        <Reveal className="section-head-center">
          ...
          <h2 className="h2">Full-stack capability, <em>one partner SR Business Solutions Private Limited </em></h2>
        </Reveal>
  ...
  return (
    <footer className="footer-v2">
      ...
      <div className="footer-bottom-v2">
        <span>© {new Date().getFullYear()} SR BUSINESS SOLUTIONS PRIVATE LIMITED. All rights reserved.</span>
